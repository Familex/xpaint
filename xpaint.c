...
static Rect canvas_apply_drawer(XImage* im, enum DrawerShape shape, u32 line_w, argb col, Pt c);
...
Rect canvas_apply_drawer(XImage* im, enum DrawerShape shape, u32 line_w, argb col, Pt c) {
    // cache
